...
router.post('/', passport.authenticate('jwt', {session: false}),
   (req, res) => {
    ...
    //Get fields
     ...
     if (req.body.website) profileFields.website = req.body.handle;
     if (req.body.location) profileFields.location = req.body.handle;
     if (req.body.bio) profileFields.bio = req.body.handle;
    ...
    if (req.body.facebook) profileFields.social.facebook = req.body.facebook;
     ...
     .then(profile => {
         if (profile) {
             ...
             //Create user profile if user was not found
            Profile.findOne({ handle: profileFields.handle})
                .then(profile => {
                    ...
                    //Save the new user profile into database
